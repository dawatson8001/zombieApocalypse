 ...
 */
final class Version20180829175851 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player ADD medicine_one_units_id INT DEFAULT NULL, ADD medicine_two_units_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player DROP medicine_one_units_id, DROP medicine_two_units_id');
    }
}
